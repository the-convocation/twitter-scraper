...
const endpoints = {
  ...
  GetInitialXChatPageQuery:
    'https://api.x.com/graphql/Gl7r1aY59L7jLBjVC98lqg/GetInitialXChatPageQuery?variables=%7B%22max_local_sequence_id%22%3A%220%22%2C%22query_settings%22%3A%7B%22inbox_conversation_event_limit%22%3A100%2C%22inbox_conversation_limit%22%3A50%2C%22conversation_event_limit%22%3A200%2C%22user_event_limit%22%3A500%7D%2C%22message_pull_version%22%3A1761251295%7D',
} as const;
